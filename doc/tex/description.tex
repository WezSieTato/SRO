...
\subsection*{Podłączenie nowego serwera warstwy wewnętrznej}

\subsection*{Podłączenie nowego serwera warstwy zewnętrznej}

\subsection*{Awaria jednego z węzłów warstwy wewnętrznej}
...
\subsection*{Awaria jednego z węzłów warstwy zewnętrznej}

\subsection*{Kwestia równomiernego podziału klientów między serwery oraz serwerów zewnętrznych między wewnętrzne}

\subsection*{Kwestia rozmieszczenia warstw serwera w obrębie jednego komputera bądź wielu odrębnych}
